 ...
 *
 * This class manages all the elements of a scene: primitives, lights, and
 * camera. It provides functionality to trace rays through the scene and find
 * intersections.
 */
class Scene {
 public:
   ...
   */
  bool isInShadow(const Vector3D& point,
 ...
 private:
  ...
  std::vector<std::shared_ptr<IPrimitive>>
      _primitives;  ///< All primitives in the scene
